      ...
      <div className="max-w-3xl mx-auto px-6 sm:px-10 py-12 sm:py-16">
        ...
        <header className="mb-10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-blue-800">Parent-friendly view</p>
          </div>
        ...
        {active && (
          <section className="mb-8 rounded-3xl border border-blue-200 bg-blue-50 px-6 py-6">
            <div className="flex items-center gap-2 mb-2 text-blue-800">
              <Sparkles className="w-3.5 h-3.5" />
              <p className="text-[10px] font-bold uppercase tracking-[0.18em]">Recommended for you</p>
            </div>
            <p className="text-xs text-blue-800 mb-1">Coming from: {active.fromLabel}</p>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-900 text-white text-sm font-bold hover:bg-blue-800 transition-colors shadow-sm"
            >
        ...
        <section className="space-y-3 mb-10">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-blue-800 mb-2">
          ...
          {ENTRIES.filter((e) => !active || e.fromSlug !== active.fromSlug).map((e) => {
            const Icon = e.Icon;
            return (
              <article key={e.fromSlug} className="rounded-2xl border border-stone-200 bg-white px-5 py-5 hover:border-blue-300 hover:shadow-md transition-all">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-2xl bg-blue-50 border border-blue-200 text-blue-800 flex items-center justify-center flex-shrink-0">
                    <Icon className="w-4 h-4" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-blue-800 mb-1">For students arriving from {e.fromLabel}</p>
                    ...
                    <Link href={e.destHref} className="inline-flex items-center gap-2 text-xs font-semibold text-blue-800 hover:text-blue-950">
