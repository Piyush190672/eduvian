...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/40 px-6 py-16">
      <Link href="/" aria-label="eduvianAI home" className="mb-10">
        <EduvianLogoMark size={48} />
      </Link>

      <div className="max-w-xl text-center">
        <p className="text-xs font-bold uppercase tracking-[0.25em] text-blue-800 mb-4">
          Error 404
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <Link
            href="/"
            className="group flex flex-col items-center gap-2 px-4 py-5 rounded-2xl border-2 border-blue-200 bg-white hover:border-blue-400 hover:shadow-lg transition-all"
          >
          ...
          <Link
            href="/profile"
            className="group flex flex-col items-center gap-2 px-4 py-5 rounded-2xl border-2 border-gray-200 bg-white hover:border-blue-300 hover:shadow-lg transition-all"
          >
            <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center group-hover:bg-blue-100 transition-colors">
        ...
        <p className="text-xs text-gray-400 mt-10 leading-relaxed">
          ...
          <a
            ...
            className="text-blue-800 hover:text-blue-950 underline-offset-2 hover:underline font-semibold"
          >
            email support
          </a>
          .
