    ...
    <div className="min-h-screen bg-white font-sans antialiased text-gray-900">
      ...
      <section className="relative bg-[#0E1119] text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 pt-28 sm:pt-36 pb-16 sm:pb-20">
          <p className="text-[11px] uppercase tracking-[0.25em] text-blue-300/85 mb-8 font-semibold">Methodology</p>
          <h1 className="font-display font-bold text-[2.25rem] leading-[1.08] sm:text-5xl md:text-[3.75rem] tracking-tight max-w-3xl mb-7">
            How we verify <span className="italic font-medium text-blue-300">program data</span>.
          </h1>
      ...
      <section className="bg-stone-50 border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-24 sm:py-32">
          <p className="text-[11px] uppercase tracking-[0.25em] text-blue-800 font-semibold mb-8">The four rules</p>
          <div className="grid lg:grid-cols-2 gap-5 lg:gap-6">
            {[
              ...
              <div key={r.n} className="flex flex-col p-8 sm:p-10 rounded-2xl bg-white border border-stone-200 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-100 transition-all">
                <span className="font-display text-3xl font-light text-blue-900 tabular-nums mb-5">{r.n}</span>
      ...
      <section className="bg-white border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-24 sm:py-32 text-center">
          <h2 className="font-display text-3xl sm:text-5xl font-bold tracking-tight leading-[1.1] mb-6 max-w-3xl mx-auto text-gray-900">
            Ready to put the dataset to <span className="italic font-medium text-blue-800">work</span>?
          </h2>
