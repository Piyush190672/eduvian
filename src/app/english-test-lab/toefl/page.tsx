      ...
      {(() => {
        ...
        return (
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 mb-6">
            ...
            <p className="text-sm text-blue-900">Your weakest section is <strong>{weakest.label}</strong> ({weakest.score}/30). Focus your next practice session on {weakest.label.toLowerCase()} tasks before retaking the full mock.</p>
          </div>
        );
      })()}
