...
// who dismissed an older version see the new one. Last bump 14 May 2026
// (beta cap raised from 50 → 100 / month per request).
const STORAGE_KEY = "eduvian_beta_banner_dismissed_2026_05_100";
  ...
  return (
    ...
    >
      <p className="truncate text-center">
        ...
        <span className="font-bold">Beta</span> — free access for the first 100 users each month. Once the quota is full, new users can come back on the 1st of the next month.{" "}
