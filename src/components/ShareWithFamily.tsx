  ...
  return (
    <section className={`rounded-3xl border border-stone-200 bg-stone-50 px-5 py-5 sm:px-6 sm:py-6 ${className}`}>
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-blue-800">Share with family</p>
      </div>
      ...
      {!showForm ? (
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-stone-200 text-gray-800 text-xs font-bold hover:border-blue-300 hover:text-blue-800 transition-colors"
          >
          ...
          {parentViewHref && (
            <a
              href={parentViewHref}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-900 text-white text-xs font-bold hover:bg-blue-800 transition-colors shadow-sm"
            >
        ...
        <form onSubmit={handleSend} className="space-y-2">
          ...
          <input
            ...
            required
            className="w-full px-3 py-2 rounded-xl border border-stone-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
          />
          <input
            type="text"
            value={subject}
          ...
          <textarea
            ...
            required
            rows={4}
            className="w-full px-3 py-2 rounded-xl border border-stone-200 bg-white text-xs leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-300"
          />
          ...
          <div className="flex items-center gap-2">
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-900 text-white text-xs font-bold hover:bg-blue-800 transition-colors disabled:opacity-50"
            >
