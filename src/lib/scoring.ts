...
const FIELD_NAME_PATTERNS: Record<string, RegExp> = {
  ...
  "International Relations":     /\b(international relations|international affairs|diplomacy|global affairs|international studies)\b/i,
  "Public Policy & Administration": /\b(public policy|public administration|public affairs)\b/i,
  "Film & Animation":            /\b(film|cinema|animation|vfx|visual effects)\b/i,
  "Renewable Energy":            /\b(renewable energy|sustainable energy|energy systems|solar energy|wind energy)\b/i,
